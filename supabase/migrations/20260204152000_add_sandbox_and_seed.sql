-- ===================================================================
-- CAP Event Command System - Add sandbox columns + seed sandbox data
-- ===================================================================

BEGIN;

-- Add sandbox_mode columns if missing
ALTER TABLE events ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;
ALTER TABLE locations ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;
ALTER TABLE activities ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;
ALTER TABLE assets ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;
ALTER TABLE personnel ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;
ALTER TABLE roster ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;
ALTER TABLE logs ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;
ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS sandbox_mode BOOLEAN DEFAULT FALSE;

-- ===================================================================
-- Sandbox seed data (idempotent via fixed IDs)
-- ===================================================================
